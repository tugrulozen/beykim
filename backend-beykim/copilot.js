...
const KB = [
  ...
  { id: 'kb-unload', kw: ['mal kabul nasil', 'aractan mal kabul', 'arac bosalt', 'tedarikci araci', 'gelen malzeme'], title: 'Araçtan mal kabul', steps: ['<b>Araçtan Mal Kabul</b> menüsünde teslim alan ambarı ve araç plakasını girin.', 'Gelen malzemelerin barkodlarını okutun; malzeme ambara girer.', 'Satın alma siparişine bağlı teslimatlarda <b>Satın Alma & Tedarik › sipariş › Mal kabul</b> kullanılır; irsaliye/fatura no zorunludur, kısmi teslim desteklenir.'], suggestions: ['Bekleyen satın alma siparişleri'] },
